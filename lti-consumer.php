...
function sb_lti_launch_func($attrs) {
    ...
    if ( array_key_exists('error', $data) ) {
        ...
        $html .= "<form method=\"post\" action=\"$surl\" onsubmit=\"window.location.reload()\" return false;\" target=\"$target\" id=\"launch-$id\" data-id=\"$id\" data-post=\"$data[id]\" data-auto-launch=\"$autolaunch\">";
