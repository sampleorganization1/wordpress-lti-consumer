...
function sb_lti_launch_func($attrs) {
    ...
    if ( array_key_exists('error', $data) ) {
        ...
        $html .= "<form method=\"post\" action=\"$surl\" onsubmit=\"setTimeout(function(){window.location.reload();},3)\" return false;\" target=\"$target\" id=\"launch-$id\" data-id=\"$id\" data-post=\"$data[id]\" data-auto-launch=\"$autolaunch\">";
